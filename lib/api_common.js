 ...
 * })
 * ```
 * @param {String} appid 在小程序平台上申请得到的appid
 * @param {String} appsecret 在小程序平台上申请得到的app secret
...
API.prototype.clearQuota = function (callback) {
  this.preRequest(this._clearQuota, arguments);
};

API.prototype._clearQuota = function (callback) {
  var url = this.endpoint + '/cgi-bin/component/clear_quota?access_token=' + this.token.accessToken;
  var data = {
    'appid': this.appid,
  };
